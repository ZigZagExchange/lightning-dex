    ...
    return (
        <div className={styles.container}>
            <button className={styles.button} onClick={toggle}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="text-white">
                    ...
                    <div className={styles.menu_content}>
                        ...
                        <div className={styles.menu_link_container}>
                            <a href="https://docs.zigzag.exchange/" target="_blank" rel="noopener noreferrer" className={styles.menu_link}>
                                ...
                                <p className={styles.menu_link_content}>
                                    Docs
                                </p>
                            </a>

                            <a href="https://discord.gg/zigzag" target="_blank" rel="noopener noreferrer" className={styles.menu_link}>
                            ...
                            <a href="https://t.me/zigzagexchange" target="_blank" rel="noopener noreferrer" className={styles.menu_link}>
                            ...
                            <a href="https://twitter.com/ZigZagExchange" target="_blank" rel="noopener noreferrer" className={styles.menu_link}>
                            ...
                            <a href="https://github.com/ZigZagExchange" target="_blank" rel="noopener noreferrer" className={styles.menu_link}>
