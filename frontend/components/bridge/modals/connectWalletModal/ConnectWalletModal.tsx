            ...
            <div className="inline-block px-6 pt-2 pb-4 overflow-hidden text-left align-bottom transition-all transform  rounded-lg shadow-xl sm:align-middle w-96 " role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                ...
                <div className={styles.button_group}>
                    <div className="flex flex-col pt-4">
                        ...
                        <button className="inline-flex items-center py-2 px-6 my-4 rounded-xl mt-2 shadow-sm border border-transparent  group transition-all duration-75 hover:!border-sky-500  hover:bg-[#5397F7] hover:bg-opacity-30">
                        ...
                        <button className="inline-flex items-center py-2 px-6 my-4 rounded-xl mt-2 shadow-sm border border-transparent  group transition-all duration-75 hover:!border-yellow-500  hover:bg-[#5397F7] hover:bg-opacity-30">
                        ...
                        <button className="inline-flex items-center py-2 px-6 my-4 rounded-xl mt-2 shadow-sm border border-transparent  group transition-all duration-75 hover:!border-blue-500  hover:bg-[#5397F7] hover:bg-opacity-30">
