...
function MobileMenu({
  ...
  return (
    <div className="lg:hidden">
      <div
        className={`absolute inset-x-0 top-0 z-[20] transition origin-top-right transform ${
          !isOpen ? "hidden" : ""
        }`}
      >
        <div className="h-full min-h-full divide-y divide-gray-600 bg-[#0f1a26]">
          <div className="px-4 pt-1 pb-6">
            <div className="flex items-center justify-between mt-5 ml-3">
              ...
              <div className="-mr-2">
                <button
                  className="rounded-lg p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-400 hover:bg-gray-900 focus:outline-none"
                  type="button"
                  onClick={() => {
                    setIsOpen(false);
                  }}
            ...
            <div className="mt-6">
              <div className="grid grid-cols-1 gap-2  py-6 ">
                <Link
                  href="/about"
                  className="block  px-3 pt-2 pb-2 rounded-lg text-[rgba(255,255,255,0.5)] hover:text-opacity-100"
                >
                ...
                <Link
                  href="/explorer"
                  target="_blank"
                  className="block  px-3 pt-2 pb-2 rounded-lg  hover:text-opacity-100"
                >
          ...
          <div className="grid grid-cols-1 gap-4  px-4 py-4">
            <div className="inline-block">
              <div className="flex items-center">
                <button
                  className="group text-white outline-none active:outline-none ring-none transition-all duration-100 transform-gpu w-full cursor-pointer rounded-lg py-2 pl-2.5 pr-2.5 group focus:outline-none focus:ring-0 border border-transparent bg-transparent focus:bg-transparent active:bg-transparent hover:!border-gray-500"
      ...
      <div
        className="items-center justify-center -mr-2 sm:flex lg:hidden"
        onClick={() => {
          setIsOpen(true);
        }}
      >
        <button
          className="rounded-lg p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-400 hover:bg-gray-800 focus:outline-none"
