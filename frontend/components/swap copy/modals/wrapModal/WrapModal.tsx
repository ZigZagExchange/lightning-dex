        ...
        <div className={styles.buy_sell_tokens}>
          <div className={styles.sell_token}>
            ...
            <div className={styles.token_symbol}>
              <Image src={`/tokenIcons/${sellTokenInfo.symbol.toLocaleLowerCase()}.svg`} width="35" height="35" alt="" />
            </div>
          </div>
          ...
          <div className={styles.buy_token}>
            ...
            <div className={styles.token_symbol}>
              <Image src={`/tokenIcons/${buyTokenInfo.symbol.toLocaleLowerCase()}.svg`} width="35" height="35" alt="" />
            </div>
          </div>
        </div>
